...
#ifdef __KERNEL__
/* Kernel builds are freestanding (-nostdinc) and have no <stddef.h>/<stdint.h>;
 * the kernel's own headers provide the equivalent fixed-width types.
 * (Only this include block differs from the upstream rgb565-rle header.) */
